// ░░ Baustein 03 – Kurslogik / Engine-Steuerung (v2.3.7) ░░
// Fix: Kein Springen mehr (weder hoch noch runter) beim Fragenwechsel
// Fix: Sanfte Auswertung, unveränderte Punktelogik
// Status: stabil & synchron mit block-04-engine.js vorbereitbar

document.addEventListener("DOMContentLoaded", () => {
  console.log("🧭 Course Engine v2.3.7 aktiv – Scrollverhalten fixiert.");
  ...
  function freezeScrollPosition(fn) {
    ...
    // Nur korrigieren, wenn sich der Content verkürzt hat (verhindert Sprung nach unten)
