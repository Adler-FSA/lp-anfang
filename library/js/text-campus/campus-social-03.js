// /library/js/text-campus/campus-social-03.js
// Zielgruppe 3 – Freunde, Familie & Bekannte
// Vollversion DE/EN, inkl. interner Anleitungen für Telefonleitfäden
// Steuert die Anzeige in social.html (Option 1 – Vollfläche öffnen + Schließen-Button)
...
const campusSocial03 = {
  ...
  de: {
    ...
    sections: [
      {
        id: "messenger",
        label: "1. WhatsApp / Facebook / Telegram – Textvorlagen",
        blocks: [
          {
            heading: "Vorlage 1 – „Ich wünsch mir, dass du sicher bist“",
            body: [
              "Ich seh, wie viele sich abmühen – arbeiten, sparen, hoffen, dass alles gut geht.",
              "Aber kaum jemand erklärt, wie man sich wirklich absichert, wenn die Preise steigen, Jobs unsicher werden oder Schulden drücken.",
              "Genau deshalb hab ich mich mit der FSA-Akademie beschäftigt. Dort lernst du, wie du dein Geld, deine Zeit und deine Entscheidungen wieder selbst steuerst.",
              "➡️ Ich schick dir den Link zum kostenlosen Grundkurs, wenn du willst. Ich glaub, das ist gerade wichtiger denn je."
            ]
          },
          {
            heading: "Vorlage 2 – „Freiheit fängt im Kopf an“",
            body: [
              "Wir alle reden über Sicherheit – Haus, Job, Konto. Aber kaum jemand redet darüber, was echte Freiheit bedeutet.",
              "Ich hab gelernt: Es geht nicht darum, reich zu werden, sondern klar zu verstehen, wie Systeme funktionieren.",
              "Seit ich den Grundkurs der FSA-Akademie gemacht hab, geh ich anders mit Geld um – ruhiger, bewusster.",
              "➡️ Vielleicht interessiert’s dich auch. Ich schick dir den Kurslink – ist kostenlos und echt gut erklärt."
            ]
          },
          {
            heading: "Vorlage 3 – „Zeit für das, was zählt“",
            body: [
              "Ich hab gemerkt, wie viel Lebenszeit in Rechnungen, Stress und Sorgen steckt.",
              "Aber finanzielle Souveränität heißt: wieder Zeit haben – für Familie, Freunde, Hobbys, sich selbst.",
              "Die FSA-Akademie zeigt, wie man das Schritt für Schritt aufbaut, ohne Druck, ohne Risiko.",
              "➡️ Ich wünsch mir, dass wir uns bald mal wieder sehen – frei im Kopf und mit mehr Zeit für das, was zählt."
            ]
          },
          ...
          {
            heading: "Vorlage 5 – „Was, wenn morgen dein Konto eingefroren wird?“",
            body: [
          ...
          {
            heading: "Vorlage 6 – „Ich will, dass wir frei bleiben“",
            body: [
      ...
      {
        id: "email",
        label: "2. E-Mail-Vorlagen (Kontaktaufnahme)",
        blocks: [
          {
            heading: "E-Mail 1 – „Ich will dir was zeigen, das mir geholfen hat“",
            body: [
              "Betreff: Wie ich wieder mehr Klarheit gewonnen hab",
              "Hallo [Name],",
              "ich weiß, du hast viel um die Ohren – Job, Familie, Alltag. Ging mir genauso.",
              "Dann bin ich auf die FSA-Akademie gestoßen. Kein MLM, kein Druck, einfach Wissen: Wie Geld wirklich funktioniert, wie man sich vor Krisen schützt und wieder Ruhe findet.",
              "Der Grundkurs ist kostenlos und ehrlich gesagt – das Beste, was ich seit Langem gemacht hab.",
          ...
          {
            heading: "E-Mail 2 – „Souveränität ist kein großes Wort“",
            body: [
              "Betreff: Ein kleiner Schritt, der viel verändert hat",
              "Hallo [Name],",
              "ich dachte früher, „finanzielle Freiheit“ wäre nur für Reiche.",
              "Aber im Grundkurs der FSA-Akademie hab ich verstanden, dass Freiheit mit Wissen anfängt.",
              "Ich hab’s ausprobiert – kein Verkauf, kein Hype, einfach Klartext.",
              "Wenn du magst, zeig ich dir, wie’s funktioniert.",
              "Alles Liebe,",
              "[Dein Name]"
            ]
          },
          {
            heading: "E-Mail 3 – „Weil du mir wichtig bist“",
            body: [
              "Betreff: Darum schick ich dir das hier",
              "Hey [Name],",
              "ich weiß, du denkst vielleicht: „Nicht noch so ein Online-Kurs.“",
              "Aber dieser ist anders. Kein Verkauf, kein Zwang – einfach lernen, wie man finanziell selbstständig wird.",
              "Ich hab’s selbst getestet, und ich wär froh gewesen, das Wissen früher gehabt zu haben.",
              "Hier ist der Link, schau’s dir an, wenn du magst.",
              "Alles Gute,",
              "[Dein Name]"
            ]
          },
          ...
          // Trustyfy / Kontroll-Thema
          {
            ...
            body: [
              "Betreff: Bevor der digitale Euro alles ändert",
              "Hey [Name],",
          ...
          {
            heading: "E-Mail 5 – „Freiheit ist keine Verschwörung“",
            body: [
              "Betreff: Warum ich jetzt anders handle",
              "Hallo [Name],",
          ...
          {
            heading: "E-Mail 6 – „Ich will, dass du vorbereitet bist“",
            body: [
              "Betreff: Bevor Kontrolle zum Alltag wird",
              "Hey [Name],",
      ...
      {
        id: "phone",
        label: "3. Telefon-Leitfäden (mit interner Anleitung)",
        blocks: [
          {
            heading: "Leitfaden 1 – „Ehrlich unter Freunden“",
            body: [
              "🔹 Interne Anleitung",
              "Ziel: Aufrichtiges, persönliches Gespräch. Keine Panik, aber klare Worte über Verlust von Freiheit und Kontrolle. Der Hörer soll fühlen, dass du dir Sorgen machst, nicht, dass du etwas verkaufst.",
              "Dauer: 5–7 Minuten",
              "Stil: Vertraut, ruhig, ehrlich.",
              "Zielhandlung: Einladung zu einem kurzen Online-Gespräch oder Zoom-Call (15 Minuten).",
              "",
              "🔹 Vorlese-Skript",
          ...
          {
            heading: "Leitfaden 2 – „Was, wenn morgen dein Konto dicht ist?“",
            body: [
              "🔹 Interne Anleitung",
              "Ziel: Gedankliche Konfrontation. Der Gesprächspartner soll begreifen, wie verletzlich digitale Abhängigkeit ist. Die Lösung kommt als Erleichterung – nicht als Verkaufsargument.",
              "Dauer: 6–8 Minuten",
              "Stil: Direkt, aber respektvoll; deutlich, nicht übertrieben.",
              "Zielhandlung: Termin für ein Informationsgespräch oder Link zum Einstieg senden.",
              "",
              "🔹 Vorlese-Skript",
          ...
          {
            heading: "Leitfaden 3 – „Freiheit statt Kontrolle“",
            body: [
              "🔹 Interne Anleitung",
      ...
      },
      {
        ...
        blocks: [
          ...
          {
            heading: "Alternativ-Snippets (FSA / Wissen)",
            body: [
              "1️⃣ „Ich hab was gefunden, das Ruhe bringt – Wissen statt Angst. Schau dir den kostenlosen FSA-Grundkurs an.“",
              "2️⃣ „Freiheit beginnt im Kopf – und mit Wissen. FSA zeigt, wie du dich selbst absicherst.“",
              "3️⃣ „Mehr Zeit für das, was zählt. FSA hilft, Geld und Freiheit wieder zu verstehen.“"
            ]
          }
        ]
      }
  ...
  en: {
    ...
    sections: [
      {
        id: "messenger",
        label: "1. WhatsApp / Facebook / Telegram – Text templates",
        blocks: [
          {
            heading: "Template 1 – “I just want you to be safe”",
            body: [
              "I see how many people work, save, hope – and still it feels tighter every month.",
              "But hardly anyone explains how to actually protect yourself when prices rise, jobs get unstable or debts push.",
              "That’s why I looked into the FSA Academy. You learn how to control your money, your time and your decisions again.",
              "➡️ I can send you the free starter course if you like – I honestly think it’s more important than ever."
            ]
          },
          {
            heading: "Template 2 – “Freedom starts in your head”",
            body: [
              "We all talk about security – house, job, bank account.",
              "But real freedom means understanding how the system works.",
              "Since I did the FSA basic course, I handle money differently – calmer, clearer.",
              "➡️ If you want, I’ll send you the link. It’s free and explained in simple language."
            ]
          },
          {
          ...
          {
            heading: "Template 4 – “I see what’s coming – and it worries me”",
            body: [
          ...
          {
            heading: "Template 5 – “What if your account is blocked tomorrow?”",
            body: [
      ...
      {
        id: "email",
        label: "2. Email templates",
        blocks: [
          {
            heading: "Email 1 – “I want to show you something that helped me”",
            body: [
              "Subject: How I got more clarity again",
              "Hi [Name],",
              "I know you’ve got a lot on your plate – work, family, life. Same here.",
              "Then I found the FSA Academy. No selling, no MLM, just education: how money really works, how to protect yourself, how to calm down again.",
              "The intro course is free and honestly – it was the best thing I did lately.",
          ...
          {
            heading: "Email 2 – “Sovereignty is not a big word”",
            body: [
              "Subject: A small step that changes a lot",
              "Hi [Name],",
              "I used to think “financial freedom” was only for rich people.",
              "But in the FSA course I realized freedom starts with understanding.",
              "I tested it – no hype, just clear talk.",
          ...
          {
            heading: "Email 3 – “Because you matter to me”",
            body: [
              "Subject: That’s why I’m sending you this",
              "Hey [Name],",
              "I know, you might think: “Not another online course.”",
              "But this one is different. No pressure, no sales pitch – just learning how to stay financially independent.",
              "I wish I had known it earlier.",
              "Here’s the link – check it out when you have a quiet moment.",
              "All the best,",
              "[Your Name]"
            ]
          },
          {
            heading: "Email 4 – “Before the digital euro changes everything”",
            body: [
      ...
      {
        id: "phone",
        label: "3. Phone guides (with internal notes)",
        blocks: [
          {
            heading: "Phone Guide 1 – Honest talk between friends",
            body: [
              "🔹 Internal notes",
              "Goal: warm, personal, protective. Not salesy.",
              "Duration: 5–7 minutes.",
              "Outcome: 15-minute online call.",
              "",
              "🔹 Script",
...
// ===============================================================
// GLOBAL HOOK
window.renderSocialZielgruppe3 = function (lang) {
  renderSocialZielgruppe3(lang || localStorage.getItem("fsa_lang") || "de");
};
...
document.addEventListener("fsa:lang-change", (ev) => {
  ...
  if (current && current.innerHTML.trim() !== "") {
    renderSocialZielgruppe3(ev.detail || "de");
  }
});
